...
@media all {
    ...
    #wp-admin-bar-popup-maker>.ab-item::before {
        background: url(https://leamh.org/wp-content/plugins/popup-maker/assets/images/admin/icon-info-21x21.png) center center no-repeat !important;
        top: 3px;
        content: '';
        width: 20px;
        height: 20px
    ...
    #wp-admin-bar-popup-maker>.ab-item:hover::before {
        background-image: url(https://leamh.org/wp-content/plugins/popup-maker/assets/images/admin/icon-info-21x21.png) !important
    }
